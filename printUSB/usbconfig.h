...
#define USB_CFG_VENDOR_ID 0xac, 0x05 /* = 0x05ac, apple */
#define USB_CFG_DEVICE_ID 0x67, 0x02 /* = 0x021e, keyboard? */

/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   'F','0','T','6','3','3','3','0','1','8','B','G','9','K','P','A','U'
 ...
 * the implications!
 */
#define USB_CFG_DEVICE_VERSION  0x05, 0x08
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'M','a','g','i','c',' ','K','e','y','b','o','a','r','d'
